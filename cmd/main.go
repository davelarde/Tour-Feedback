...
var dummyData = map[string][]string{
	"2023-09-01": {"danielavelarde4@gmail.com", "davelard@cisco.com"},
...
func CompleteTourHandler(ctx context.Context, request events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
	...
	tourCompleted := requestBody["completed"] // this is the parameter to indicate if the tour was completed.
...
func SendSurveyEmail(emailAddresses []string) error {
	...
	subject := "Philadelphia Foodie Night Tour Survey"
	body := "Hello there!  Please take our survey to help us improve our service https://www.surveymonkey.com/r/VQ8L5ZB"
